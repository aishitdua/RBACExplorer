...
async def get_current_user(
    ...
    try:
        ...
        # Refresh-on-key-miss: the key ID was not found in the cached JWKS;
        # force a refresh and retry once with a freshly fetched JWKS.
        ...
        try:
            ...
            raise HTTPException(401, "Invalid or expired token") from retry_e
