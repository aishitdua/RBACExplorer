    ...
    <div className="min-h-screen bg-gray-950 flex flex-col items-center justify-center p-6 sm:p-8">
      <div className="w-full max-w-lg space-y-10">
        ...
        <div className="grid grid-cols-1 gap-8">
          {/* Create Section */}
          <form onSubmit={handleCreate} className="bg-gray-900 border border-gray-800 rounded-3xl p-8 shadow-2xl space-y-6">
          ...
          <div className="bg-gray-900/50 border border-gray-800 rounded-3xl p-8 space-y-6 relative">
            <div className="space-y-1">
              ...
              <p className="text-gray-500 text-xs">Search for an existing project by name or slug</p>
            </div>
                  ...
                  <div className="max-h-60 overflow-y-auto py-2">
                    {filteredProjects.length > 0 ? (
                      filteredProjects.map(project => (
                        ...
                        >
                          <div>
                            <div className="text-sm font-bold text-white group-hover:text-blue-400 transition-colors">{project.name}</div>
                            <div className="text-[10px] text-gray-500 font-mono tracking-tighter uppercase">{project.slug}</div>
                          </div>
